...
/* compares two TYPE values to each other, define this in your compare.c file */
int compare(TYPE left, TYPE right);

/* prints TYPE values, define this in your compare.c file */
...
int containsBSTree(struct Node   *node, TYPE val);
